    ...
    def game_round(self):
        ...
        for i in range(self.max_timestep):
            ...
            if self.RL_controller is None:
                ...
                action , V_values = self.RL_controller.get_action(self.pendulum.get_discrete_values(), self.surface_array,
            ...
            if terminal:
                break;
        count_zeros = np.prod(V_values.shape) - np.count_nonzero(V_values)
        print(count_zeros)
        self.game_round_number += 1

        # if(self.game_round_number%10 == 0):
        if(self.game_round_number > 2000 and self.game_round_number < 2020 ):
            ...
            np.savetxt('my_array2.txt', V_values, fmt='%f')
        if(self.game_round_number > 4000 and self.game_round_number < 4020 ):
            ...
            np.savetxt('my_array4.txt', V_values, fmt='%f')
        if(self.game_round_number > 6000 and self.game_round_number < 6020 ):
            ...
            np.savetxt('my_array6.txt', V_values, fmt='%f')
        if(self.game_round_number > 8000 and self.game_round_number < 8020 ):
            ...
            np.savetxt('my_array7.txt', V_values, fmt='%f')
        if(self.game_round_number > 10000 and self.game_round_number < 10020 ):
            ...
            np.savetxt('my_array10.txt', V_values, fmt='%f')
        if(self.game_round_number > 12000 and self.game_round_number < 12020 ):
            ...
            np.savetxt('my_array12.txt', V_values, fmt='%f')
        if(self.game_round_number > 14000 and self.game_round_number < 14020 ):
            ...
            np.savetxt('my_array14.txt', V_values, fmt='%f')
        if(self.game_round_number > 16000 and self.game_round_number < 16020 ):
            ...
            np.savetxt('my_array16.txt', V_values, fmt='%f')
                        
        if(self.game_round_number > 18000 and self.game_round_number < 18020 ):
            ...
            np.savetxt('my_array18.txt', V_values, fmt='%f')
        if(self.game_round_number > 20000 and self.game_round_number < 20020 ):
            ...
            np.savetxt('my_array20.txt', V_values, fmt='%f')
